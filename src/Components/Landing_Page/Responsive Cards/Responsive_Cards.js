...
//                 <div className="w-[480px] h-1 mx-auto mt-2 mb-4 bg-blue-600"></div>
...
//             <article
//                 class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900  px-8 py-8 pb-8">
//                 <img src="https://images.pexels.com/photos/1815385/pexels-photo-1815385.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover"/>
...
//                 <img src="https://images.pexels.com/photos/1051075/pexels-photo-1051075.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover"/>
//                 <div class="absolute inset-0 -z-10 bg-gradient-to-t from-gray-900 via-gray-900/40"></div>
//                 <div class="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-gray-900/10"></div>
//                 <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm leading-6 text-gray-300"><time
...
//             <article
//                 class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 dark:bg-gray-700 px-8 py-8 pb-8 pt-80 sm:pt-48 lg:pt-80">
//                 <img src="https://images.pexels.com/photos/119777/pexels-photo-119777.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover"/>
//                 <div class="absolute inset-0 -z-10 bg-gradient-to-t from-gray-900 via-gray-900/40"></div>
//                 <div class="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-gray-900/10"></div>
//                 <div class="flex flex-wrap items-center gap-y-1 overflow-hidden text-sm leading-6 text-gray-300"><time
                ...
                <div className="grid max-w-2xl grid-cols-1 gap-8 mx-auto mt-8 auto-rows-fr sm:mt-12 lg:mx-0 lg:max-w-none lg:grid-cols-3 ">
                    <article className="relative flex flex-col justify-end px-8 py-8 pb-8 overflow-hidden transition-transform duration-300 ease-in-out bg-gray-900 hover:rotate-3 isolate rounded-2xl">
                        ...
                        <div className="flex flex-wrap items-center overflow-hidden text-sm leading-6 text-gray-300 gap-y-1">
                            <time datetime="2023-10-11" className="mr-8">Oct 11, 2023</time>
                            <div className="flex items-center -ml-4 gap-x-4">
                                <svg viewBox="0 0 2 2" className="-ml-0.5 h-0.5 w-0.5 flex-none fill-white/50">
                                    <circle cx="1" cy="1" r="1"></circle>
                                </svg>
                                <div className="flex gap-x-2.5">
                                    <img src="https://randomuser.me/api/portraits/men/2.jpg" alt="" className="flex-none w-6 h-6 rounded-full bg-white/10"/>John
                                </div>
                            </div>
                        </div>
                    ...
                    <article className="relative flex flex-col justify-end px-8 py-8 pb-8 overflow-hidden transition-transform duration-300 ease-in-out bg-gray-900 hover:scale-105 isolate rounded-2xl dark:bg-gray-700 pt-80 sm:pt-48 lg:pt-80">
                        <img src="https://images.pexels.com/photos/1051075/pexels-photo-1051075.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" className="absolute inset-0 object-cover w-full h-full -z-10"/>
                        <div className="absolute inset-0 -z-10 bg-gradient-to-t from-gray-900 via-gray-900/40"></div>
                        <div className="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-gray-900/10"></div>
                        <div className="flex flex-wrap items-center overflow-hidden text-sm leading-6 text-gray-300 gap-y-1">
                            <time datetime="2023-09-25" className="mr-8">Sept 25, 2023</time>
                            <div className="flex items-center -ml-4 gap-x-4">
                                <svg viewBox="0 0 2 2" className="-ml-0.5 h-0.5 w-0.5 flex-none fill-white/50">
                                    <circle cx="1" cy="1" r="1"></circle>
                                </svg>
                                <div className="flex gap-x-2.5">
                                    <img src="https://randomuser.me/api/portraits/women/2.jpg" alt="" className="flex-none w-6 h-6 rounded-full bg-white/10"/>Jane
                                </div>
                            </div>
                        </div>
                        <h3 className="mt-3 text-lg font-semibold leading-6 text-[#f58d03]">
                    ...
                    <article className="relative flex flex-col justify-end px-8 py-8 pb-8 overflow-hidden transition-transform duration-300 ease-in-out bg-gray-900 hover:-rotate-3 isolate rounded-2xl dark:bg-gray-700 pt-80 sm:pt-48 lg:pt-80">
                        <img src="https://images.pexels.com/photos/119777/pexels-photo-119777.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" className="absolute inset-0 object-cover w-full h-full -z-10"/>
                        <div className="absolute inset-0 -z-10 bg-gradient-to-t from-gray-900 via-gray-900/40"></div>
                        <div className="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-gray-900/10"></div>
                        <div className="flex flex-wrap items-center overflow-hidden text-sm leading-6 text-gray-300 gap-y-1">
                            <time datetime="2023-09-24" className="mr-8">Sept 24, 2023</time>
                            <div className="flex items-center -ml-4 gap-x-4">
                                <svg viewBox="0 0 2 2" className="-ml-0.5 h-0.5 w-0.5 flex-none fill-white/50">
                                    <circle cx="1" cy="1" r="1"></circle>
                                </svg>
                                <div className="flex gap-x-2.5">
                                    <img src="https://randomuser.me/api/portraits/men/4.jpg" alt="" className="flex-none w-6 h-6 rounded-full bg-white/10"/>Michael
                                </div>
                            </div>
                        </div>
                        <h3 className="mt-3 text-lg font-semibold leading-6 text-[#f58d03]">
