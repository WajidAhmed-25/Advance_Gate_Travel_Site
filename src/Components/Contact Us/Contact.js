export default function Travel_Contact(){
    ...
    return(
        ...
        <h2 className="pb-2 mt-12 text-4xl font-bold text-center">Message us Now !!</h2>
  ...
  <p className="mb-6 text-xl text-center text-gray-500">We Offer 24/7 Customer support</p>
        ...
        <div class="w-full md:w-2/5 p-4">
          ...
          <h2 class="text-xl md:text-6xl font-semibold mb-5 text-blue-900">GET IN TOUCH!</h2>
          <form class="space-y-4">
            <div>
              <input type="text" id="fullName" name="fullName" placeholder='Full Name' class="mt-1 p-4 w-full rounded-md border-2 border-blue-900/50" />
            </div>
            <div>
              <input type="email" id="email" name="email" placeholder='Email' class="mt-1 p-4 w-full border-2 border-blue-900/50 rounded-md" />
            </div>
            <div>
              <textarea id="message" name="message" placeholder='Message' class="mt-1 p-4 w-full  rounded-md border-2 border-blue-900/50" rows="4"></textarea>
            </div>
            <button type="submit" class="px-6 py-4 rounded-md bg-blue-900 text-white hover:bg-blue-700 ml-[80%] font-bold">Submit</button>
          </form>
        </div>
