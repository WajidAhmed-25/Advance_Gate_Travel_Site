...
<div class="flex justify-center flex-col items-center px-4 py-6">
    ...
    <div className="h-[4px] w-[880px] md:w-[740px]   sm:w-[460px]  max-xs:w-[300px] pl-4 pr-4 bg-[#f58d03] mt-[18px]"></div>
        ...
        <div className="grid grid-cols-1 gap-8 mt-24 md:grid-cols-2 lg:grid-cols-3 max-xl:gap-6">
          ...
          {/* Card 1 */}
          <div className="relative w-[90%] p-2 mb-32 mx-auto bg-[#007fac] border-[#f58d03] border-2 rounded-2xl md:max-w-xs lg:max-w-md -rotate-12">
            <div className="relative w-full p-6 h-[257px] text-center bg-gradient-to-br border-[#f58d03] border-2 from-[#ffffff] via-[#74aabcd6] to-[#ffffff] rounded-lg rotate-12 shadow-md  ">
              ...
              <button class="py-2.5 px-6 mt-4 rounded-lg text-sm font-medium text-white border-[#f58d03] border-2 bg-[#007fac] hover:scale-125 transition-all duration-300 cursor-pointer">Learn More</button>
            </div>
          </div>
  
          {/* Card 2 */}
          <div className="relative w-[90%] p-2 mx-auto mb-32 bg-[#007fac] rotate-12 border-[#f58d03] border-2 rounded-2xl md:max-w-xs lg:max-w-md">
            <div className="relative w-full p-6 h-[257px] text-center -rotate-12 bg-gradient-to-br from-[#ffffff] via-[#74aabcd6] to-[#ffffff] rounded-lg shadow-md border-[#f58d03] border-2 ">
          ...
          {/* Card 3 */}
          <div className="relative w-[90%] p-2 mx-auto mb-32 bg-[#007fac] rounded-2xl md:max-w-xs lg:max-w-md -rotate-12 border-[#f58d03] border-2">
            <div className="relative w-full p-6 h-[257px] text-center rotate-12 bg-gradient-to-br from-[#ffffff] via-[#74aabcd6] to-[#ffffff] rounded-lg shadow-md border-[#f58d03] border-2 ">
    ...
    <button class="py-2.5 px-6 mt-4 rounded-lg text-sm font-medium border-[#f58d03] border-2 text-white bg-[#007fac] hover:scale-125 transition-all duration-300 cursor-pointer">Learn More</button>
